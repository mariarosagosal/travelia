...
<?php 
  ...
  $kategoriother = mysqli_query($connection, "SELECT * from fotokategori, kategori
                              where kategori.kategoriID = fotokategori.kategoriID and kategori.kategoriID != 'KW06'");
  $thiskategori = mysqli_query($connection, "SELECT * from kategori, fotokategori where kategori.kategoriID = 'KW06' AND kategori.kategoriID = fotokategori.kategoriID");
  $deskategori = mysqli_query($connection, "SELECT * from destinasi, kategori, fotodestinasi where kategori.kategoriID = 'KW06' and destinasi.kategoriID = kategori.kategoriID and destinasi.destinasiID = fotodestinasi.destinasiID");
  
  $notthiskategori = mysqli_query($connection, "SELECT * from destinasi, kategori where kategori.kategoriID != 'KW06' and destinasi.kategoriID != 'KW06' and destinasi.kategoriID = kategori.kategoriID");
  $jmlnotthiskategori = mysqli_num_rows($notthiskategori);

  $kategorilain = mysqli_query($connection, "SELECT * from kategori where kategoriID != 'KW06'");
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 600px;">
      <img class="d-block w-100" src="images/wisataseni.jpg" alt="First slide">
  </div>
</div>
</div>
<!--    akhir slider -->
...
<div class="container" style="margin-top: 100px; margin-bottom: 100px;">
  <div class="col-sm-12">
  <h1 style="margin-bottom: 30px;">WISATA SENI</h1>
    <?php
    while($row1 = mysqli_fetch_array($thiskategori)) { ?>
      ...
      <blockquote class="blockquote blockquote--bordered">
        <p class="blockquote__text">
          Wisata yang diberdayakan untuk pergi mengunjungi destinasi kesenian dan menikmati keindahannya. Seni yang ditampilkan seperti seni tari, lukisan, serta ukiran.
        </p>
      </blockquote>
      </div>
      </div>
  ...
  <div class="carousel-inner" style="height: 400px; ">
    <div class="carousel-item active">
      <video class="img-fluid" autoplay loop muted style="display:flex; justify-content:center; width: 100%;">
        <source src="images/seni.mp4" type="video/mp4">
      </video>
      <div class="carousel-caption" style="position: absolute; top: 130px; color: whitesmoke; text-shadow: 4px 4px 2px rgba(0,0,0,0.6);">
        <h1>Seni bukanlah cermin untuk menopang masyarakat, tetapi palu untuk membentuknya.</h1>
        <h4>- Leon Trotsky</h4>
      </div>
    </div>
  </div>
...
<div class="container" style="margin: 100px auto;">
  <h2 style="margin-bottom: 60px;">Destinasi Wisata Seni</h2>
  <div class="row">
    <!-- cards -->
    <div class="col-sm-8">
      <?php
