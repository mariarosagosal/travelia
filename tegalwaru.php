...
<?php 
  ...
  $fotoTegalwaru = mysqli_query($connection, "SELECT * from area, destinasi, fotodestinasi, kategori where area.areaID = 'AR03' AND destinasi.areaID = 'AR03' and destinasi.destinasiID = fotodestinasi.destinasiID and destinasi.kategoriID = kategori.kategoriID");

  $hotel = mysqli_query($connection, "SELECT * from hotel where areaID = 'AR03'");

  $ketarea = mysqli_query($connection, "SELECT * from area where areaID = 'AR03'");
  $ketkabupaten = mysqli_query($connection, "SELECT * from area, kabupaten where area.areaID = 'AR03' AND area.kabupatenKODE = kabupaten.kabupatenKODE");

  $areaother = mysqli_query($connection, "SELECT * from area, fotodestinasi, destinasi where area.areaID != 'AR03' and area.areaID = destinasi.areaID and destinasi.destinasiID = fotodestinasi.destinasiID");
  $kategori = mysqli_query($connection, "SELECT * from kategori");
  $makanan = mysqli_query($connection, "SELECT * from kuliner WHERE areaID = 'AR03'");
  $atraksi = mysqli_query($connection, "SELECT * FROM atraksi WHERE areaID = 'AR03' LIMIT 1");
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 600px;">
      <img class="d-block w-100" src="images/hah1.jpg" alt="First slide">
      <div class="carousel-caption">
        <?php while($row = mysqli_fetch_array($ketarea)) { ?>
        <h1><?php echo $row["areanama"]?></h1>
...
<div class="container" style="margin-top: 100px;">
  <div class="col-sm-11">
  <h1 style="margin-bottom: 30px;">Tegalwaru</h1>
    <?php
    while($row1 = mysqli_fetch_array($ketkabupaten)) { ?>
      ...
      <a>Tegalwaru merupakan salah satu area wisata yang berada di wilayah
...
<div class="container" style="margin: 100px auto;">
  ...
  <div class="row">
    <?php
    while($row3 = mysqli_fetch_array($fotoTegalwaru)) { ?>
