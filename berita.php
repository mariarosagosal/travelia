...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 600px;">
      <img class="d-block w-100" src="images/berita.jpg" alt="First slide">
<!--       <div class="carousel-caption d-none d-md-block">
        <h1>BERITA WISATA</h1>
        <p>Berita gatau gatau gatau nyeneadsda ueee</p>
      </div> -->
  </div>
</div>
</div>
...
<div class="container" style="margin: 100px auto;">
  <h1 style="margin-bottom: 20px; margin-top: 100px; display: flex; justify-content:center;"><b>Berita Wisata</b></h1>
  <h5 style="display: flex; justify-content:center; margin-bottom: 60px;">Kumpulan berita terbaru tentang wisata populer di Indonesia</h5>
  <div class="row">
    <!-- cards -->
    <div class="col-sm-6">
      <?php
       ...
       ?>
      <div class="card" style="width: 100%; margin-bottom: 35px; border-radius: 10px; box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px;">
        ...
        <img class="card-img-top" style="width: 100%; height: 300px; object-fit:cover;" src="images/<?php echo $row2["fotofile"]?>" alt="Card image cap">
         <div class="card-body">
          <h4 class="card-title" style="font-size: 25px;"><?php echo $row2["beritajudul"] ?></h4>
  <!--         <h5 class="card-text" style="font-size: 18px">
            <php echo $row2["beritainti"]?>
          </h5> -->
          <p class="card-text" style="font-size: 14px; margin-left: -6px; margin-top: 15px;">
            ...
            <?php echo $row2["penulis"]?>

            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="16" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
			  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z"/>
			</svg>
          <?php echo $row2["tanggalterbit"]?>
        </p>
        </div>
      </div>
    <?php } } ?>
    ...
    <div class="col-sm-6">
      <?php
        ...
        if (mysqli_num_rows($berita1)>0) {
          while ($rowb1 = mysqli_fetch_array($berita1)) {
       ?>
      <div class="card" style="width: 100%; height: 408px; margin-bottom: 35px; border-radius: 10px; box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px;">

         <div class="card-body">
        <h5>INTI BERITA</h5><br>
       <p class="card-text" style="font-size: 18px; text-align: justify;">
            <?php echo $rowb1["beritainti"]?>
          </p>
   ...
   <!--  <div class="col-sm-4">
      <ul class="list-group">
        <li class="list-group-item d-flex justify-content-between align-items-center">
          Jumlah Obyek Wisata
          <span class="badge badge-primary badge-pill" style="background: #8D9EFF;"><php echo $jumlah ?></span>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center">
          Jumlah Berita Wisata
          <span class="badge badge-primary badge-pill" style="background: #8D9EFF;"><php echo $jumlahberita ?></span>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center">
          Morbi leo risus
          <span class="badge badge-primary badge-pill" style="background: #8D9EFF;">1</span>
        </li>
      </ul> -->
    ...
    <!-- <div class="single-widget-area mb-100">
      <div class="mb-30 touristattraction">
        <h5 style="margin-top: 50px; margin-bottom: 30px;">Wisata Populer</h5>
      </div>
      <php 
        if (mysqli_num_rows($destinasi)>0) {
          while ($row4 = mysqli_fetch_array($destinasi)) {
       ?>
      <div class="single-touristattraction-post d-flex" style="margin-bottom: 20px;">
        <div class="post-thumb">
          <a href="">
            <img src="images/<php echo $row4["fotofile"] ?>" style="width: 80px; height: 80px; object-fit:cover; margin-right: 20px;">
          </a>
        </div>
        <div class="post-date">
          <div class="" style="font-size: 16.5px;">
            <php echo $row4["destinasinama"] ?>
          </div>
          <div class="post-meta">
            <p href="" style="font-size: 13px; color: black;"><php echo $row4["kategoriketerangan"] ?></p>
          </div>
        </div>
      </div>
      <php }} ?>
