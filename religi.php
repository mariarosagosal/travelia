...
<?php 
  ...
  $kategoriother = mysqli_query($connection, "SELECT * from fotokategori, kategori
                              where kategori.kategoriID = fotokategori.kategoriID and kategori.kategoriID != 'KW04'");
  $thiskategori = mysqli_query($connection, "SELECT * from kategori, fotokategori where kategori.kategoriID = 'KW04' AND kategori.kategoriID = fotokategori.kategoriID");
  $deskategori = mysqli_query($connection, "SELECT * from destinasi, kategori, fotodestinasi where kategori.kategoriID = 'KW04' and destinasi.kategoriID = kategori.kategoriID and destinasi.destinasiID = fotodestinasi.destinasiID");
  
  $notthiskategori = mysqli_query($connection, "SELECT * from destinasi, kategori where kategori.kategoriID != 'KW04' and destinasi.kategoriID != 'KW04' and destinasi.kategoriID = kategori.kategoriID");
  $jmlnotthiskategori = mysqli_num_rows($notthiskategori);

  $kategorilain = mysqli_query($connection, "SELECT * from kategori where kategoriID != 'KW04'");
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 600px;">
      <img class="d-block w-100" src="images/wisatareligi.jpg" alt="First slide">
  </div>
</div>
</div>
<!--    akhir slider -->
...
<div class="container" style="margin-top: 100px; margin-bottom: 100px;">
  <div class="col-sm-12">
  <h1 style="margin-bottom: 30px;">WISATA RELIGI</h1>
    <?php
    while($row1 = mysqli_fetch_array($thiskategori)) { ?>
      ...
      <blockquote class="blockquote blockquote--bordered">
        <p class="blockquote__text">
          Wisata yang ditujuan guna memperdalam wawasan ekagamaan pada setiap wisatawan. Berbagai tempat dapat dijadikan destinasi wisata religi, bergantung pada agama yang dianut.
        </p>
      </blockquote>
      </div>
      </div>
  ...
  <div class="carousel-inner" style="height: 400px; ">
    <div class="carousel-item active">
      <video class="img-fluid" autoplay loop muted style="display:flex; justify-content:center; width: 100%;">
        <source src="images/religi.mp4" type="video/mp4">
      </video>
      <div class="carousel-caption" style="position: absolute; top: 130px; color: whitesmoke; text-shadow: 4px 4px 2px rgba(0,0,0,0.6);">
        <h1>Ilmu pengetahuan tanpa agama adalah pincang. Agama tanpa ilmu adalah buta.</h1>
...
<div class="container" style="margin: 100px auto;">
  <h2 style="margin-bottom: 60px;">Destinasi Wisata Religi</h2>
  <div class="row">
    <!-- cards -->
    <div class="col-sm-8">
      <?php
