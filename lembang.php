...
<?php 
  ...
  $fotolembang = mysqli_query($connection, "SELECT * from area, destinasi, fotodestinasi, kategori, kabupaten where area.areaID = 'AR01' AND destinasi.areaID = 'AR01' and destinasi.destinasiID = fotodestinasi.destinasiID and destinasi.kategoriID = kategori.kategoriID and area.kabupatenKODE = kabupaten.kabupatenKODE");
  ...
  $ketkabupaten = mysqli_query($connection, "SELECT * from area, kabupaten where area.areaID = 'AR01' AND area.kabupatenKODE = kabupaten.kabupatenKODE");

  $areaother = mysqli_query($connection, "SELECT * from area, fotodestinasi, destinasi where area.areaID != 'AR01' and area.areaID = destinasi.areaID and destinasi.destinasiID = fotodestinasi.destinasiID");

  $kategori = mysqli_query($connection, "SELECT * from kategori");

  $makanan = mysqli_query($connection, "SELECT * from kuliner WHERE areaID = 'AR01'");
  $atraksi = mysqli_query($connection, "SELECT * FROM atraksi WHERE areaID = 'AR01' ORDER BY atraksiNAMA DESC LIMIT 1");
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 600px;">
      <img class="d-block w-100" src="images/1k.jpg" alt="First slide">
...
<div class="container" style="margin-top: 100px;">
  <div class="col-sm-11">
  <h1 style="margin-bottom: 30px;">Lembang</h1>
    <?php
    while($row1 = mysqli_fetch_array($ketkabupaten)) { ?>
      ...
      <a>Lembang merupakan salah satu area wisata yang berada di wilayah
...
<div class="container" style="margin: 100px auto;">
  ...
  <div class="row">
    <?php
    while($row3 = mysqli_fetch_array($fotolembang)) { ?>
    ...
    <div class="col-md-6">
      ...
      <hr>
      <!-- <a><php echo $row3["kabupatenNAMA"]?></a>
      <img src="images/<php echo $row3["kabupatenFOTOICON"] ?>" class="figure-img img-fluid rounded" alt="Foto Tidak Ada" style="height: 40px; margin-left: 10px; object-fit: cover;"> -->
...
<!-- hotel -->
 <div class="container" style="margin: 60px auto;">
  <h1 style="margin-bottom: 30px;">Rekomendasi Hotel</h1>
  <div class="row">
    <?php
...
<!-- galeri -->
<div class="container">
  <h1 style="margin-bottom: 30px; margin-top: 100px;">Area Lainnya</h1>
  <div class="row" > 
    <?php
