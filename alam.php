...
<?php 
  ...
  $kategoriother = mysqli_query($connection, "SELECT * from fotokategori, kategori
                              where kategori.kategoriID = fotokategori.kategoriID and kategori.kategoriID != 'KW01'");
  $thiskategori = mysqli_query($connection, "SELECT * from kategori, fotokategori where kategori.kategoriID = 'KW01' AND kategori.kategoriID = fotokategori.kategoriID");
  $deskategori = mysqli_query($connection, "SELECT * from destinasi, kategori, fotodestinasi where kategori.kategoriID = 'KW01' and destinasi.kategoriID = kategori.kategoriID and destinasi.destinasiID = fotodestinasi.destinasiID");
  
  $notthiskategori = mysqli_query($connection, "SELECT * from destinasi, kategori where kategori.kategoriID != 'KW01' and destinasi.kategoriID != 'KW01' and destinasi.kategoriID = kategori.kategoriID");
  $jmlnotthiskategori = mysqli_num_rows($notthiskategori);

  $kategorilain = mysqli_query($connection, "SELECT * from kategori where kategoriID != 'KW01'");
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 600px;">
      <img class="d-block w-100" src="images/gambar.jpg" alt="First slide">
  </div>
</div>
</div>
<!--    akhir slider -->
...
<div class="container" style="margin-top: 100px; margin-bottom: 100px;">
  <div class="col-sm-12">
  <h1 style="margin-bottom: 30px;">WISATA ALAM</h1>
    <?php
    while($row1 = mysqli_fetch_array($thiskategori)) { ?>
      ...
      <blockquote class="blockquote blockquote--bordered">
        <p class="blockquote__text">
          Kegiatan perjalanan atau sebagian dari kegiatan tersebut yang dilakukan secara sukarela serta bersifat sementara untuk menikmati gejala keunikan dan keindahan alam di kawasan suaka margasatwa, taman nasional, taman hutan raya, dan taman wisata alam.
        </p>
      </blockquote>
      </div>
      </div>
...
<div class="container" style="margin: 100px auto;">
  <h2 style="margin-bottom: 60px;">Destinasi Wisata Alam</h2>
  <div class="row">
    <!-- cards -->
    <div class="col-sm-8">
      <?php
