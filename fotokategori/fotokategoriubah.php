...
<?php
  ...
  if(isset($_POST['Ubah']))
  {
  	...
  	if(empty($nama)) {
  		mysqli_query($connection, "UPDATE fotokategori set fotokategoriNAMA = '$namafoto', kategoriID = '$kodekategori'
  															 where fotokategoriID = '$kodefoto'");
  		header("location:fotokategori.php");
  	}
  	else 
  	...
  	if(($ekstensifile == "jpg") or ($ekstensifile == "JPG")) {
  		...
  		mysqli_query($connection, "UPDATE fotokategori SET
  								fotokategoriNAMA = '$namafoto',
  								fotokategoriFILE = '$nama', 
  ...
  $editfoto = mysqli_query($connection, "SELECT * from fotokategori where fotokategoriID = '$kodefoto'");
  $rowedit = mysqli_fetch_array($editfoto);

  $editkategori = mysqli_query($connection, "SELECT * from kategori, fotokategori
  															where fotokategoriID = '$kodefoto' 
  															and kategori.kategoriID = fotokategori.kategoriID");
	...
	<div class="row">
		...
		<div class="col-sm-10">
			<div class="jumbotron jumbotron-fluid">
				<div class="container">
					<h1 class="display-4">Edit Photo Kategori Wisata</h1>
				</div>
			</div>
			...
			<form method="POST" enctype="multipart/form-data">
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="kodefoto" name="inputkode" value="<?php echo $rowedit["fotokategoriID"]?>" readonly>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="namafoto" name="inputnama" value="<?php echo $rowedit["fotokategoriNAMA"]?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						...
						<img src="images/<?php echo $rowedit['fotokategoriFILE']?>" style="width: 200px; height: 100px;">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="submit" name="Ubah" class="btn btn-primary" value="Ubah" style="background: #6C4AB6;">
